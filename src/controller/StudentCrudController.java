...
public class StudentCrudController {
    ...
    public static boolean updateStudent(Student student) throws SQLException, ClassNotFoundException{
        ...
        if(CrudUtil.execute("UPDATE Student SET student_name = ?, email = ?, contact = ?, address = ?, nic = ?,  = ? WHERE student_id = ? ",student.getName(),student.getEmail(),student.getContact(),student.getAddress(),student.getNic(),student.getId())){
